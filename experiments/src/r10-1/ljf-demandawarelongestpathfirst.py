...
def perfTest():
    ...
    h9.cmd('iperf3 -c h1 -p 5009 -n 367893K -J --logfile experiments/results/0-h9-h1-2.json &&'
           'iperf3 -c h2 -p 5009 -n 209025K -J --logfile experiments/results/0-h9-h2.json &&'
           'iperf3 -c h1 -p 5009 -n 63761K -J --logfile experiments/results/0-h9-h1-1.json &')

    h7.cmd('iperf3 -c h0 -p 5007 -n 205313K -J --logfile experiments/results/0-h7-h0.json &&'
           'iperf3 -c h5 -p 5007 -n 47340K -J --logfile experiments/results/0-h7-h5.json &&'
           'iperf3 -c h3 -p 5007 -n 8342K -J --logfile experiments/results/0-h7-h3.json &')

    h6.cmd('iperf3 -c h0 -p 5006 -n 522374K -J --logfile experiments/results/0-h6-h0.json &')

    h4.cmd('iperf3 -c h7 -p 5004 -n 346907K -J --logfile experiments/results/0-h4-h7-1.json &&'
           'iperf3 -c h7 -p 5004 -n 155699K -J --logfile experiments/results/0-h4-h7-2.json &')

    h0.cmd('iperf3 -c h8 -p 5000 -n 724249K -J --logfile experiments/results/0-h0-h8.json &&'
           'iperf3 -c h6 -p 5000 -n 464581K -J --logfile experiments/results/0-h0-h6.json &&'
           'iperf3 -c h7 -p 5000 -n 120804K -J --logfile experiments/results/0-h0-h7.json &')

    h3.cmd('iperf3 -c h1 -p 5003 -n 206732K -J --logfile experiments/results/0-h3-h1.json &&'
           'iperf3 -c h4 -p 5003 -n 64159K -J --logfile experiments/results/0-h3-h4.json &')

    h8.cmd('iperf3 -c h5 -p 5008 -n 200853K -J --logfile experiments/results/0-h8-h5.json &&'
           'iperf3 -c h2 -p 5008 -n 80609K -J --logfile experiments/results/0-h8-h2.json &&'
           'iperf3 -c h0 -p 5008 -n 40866K -J --logfile experiments/results/0-h8-h0.json &')

    h1.cmd('iperf3 -c h9 -p 5001 -n 177736K -J --logfile experiments/results/0-h1-h9.json &&'
           'iperf3 -c h6 -p 5001 -n 95747K -J --logfile experiments/results/0-h1-h6.json &')
