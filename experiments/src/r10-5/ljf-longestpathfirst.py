...
def perfTest():
    ...
    h1.cmd('iperf3 -c h2 -p 5001 -n 371268K -J --logfile experiments/results/0-h1-h2-2.json &&'
           'iperf3 -c h0 -p 5001 -n 239419K -J --logfile experiments/results/0-h1-h0.json &&'
           'iperf3 -c h2 -p 5001 -n 91187K -J --logfile experiments/results/0-h1-h2-1.json &')

    h3.cmd('iperf3 -c h9 -p 5003 -n 385671K -J --logfile experiments/results/0-h3-h9.json &&'
           ...
           'iperf3 -c h6 -p 5003 -n 23472K -J --logfile experiments/results/0-h3-h6.json &')

    h7.cmd('iperf3 -c h3 -p 5007 -n 516119K -J --logfile experiments/results/0-h7-h3.json &&'
           'iperf3 -c h4 -p 5007 -n 137329K -J --logfile experiments/results/0-h7-h4.json &&'
           'iperf3 -c h5 -p 5007 -n 92577K -J --logfile experiments/results/0-h7-h5.json &')

    h0.cmd('iperf3 -c h2 -p 5000 -n 748599K -J --logfile experiments/results/0-h0-h2-1.json &&'
           'iperf3 -c h2 -p 5000 -n 75849K -J --logfile experiments/results/0-h0-h2-2.json &')

    h2.cmd('iperf3 -c h7 -p 5002 -n 276962K -J --logfile experiments/results/0-h2-h7-1.json &&'
           'iperf3 -c h7 -p 5002 -n 252336K -J --logfile experiments/results/0-h2-h7-2.json &&'
           'iperf3 -c h9 -p 5002 -n 33745K -J --logfile experiments/results/0-h2-h9.json &')

    h4.cmd('iperf3 -c h5 -p 5004 -n 195002K -J --logfile experiments/results/0-h4-h5.json &&'
           'iperf3 -c h9 -p 5004 -n 52518K -J --logfile experiments/results/0-h4-h9.json &')

    h5.cmd('iperf3 -c h1 -p 5005 -n 74751K -J --logfile experiments/results/0-h5-h1.json &')

    h8.cmd('iperf3 -c h4 -p 5008 -n 147647K -J --logfile experiments/results/0-h8-h4.json &&'
           'iperf3 -c h1 -p 5008 -n 71305K -J --logfile experiments/results/0-h8-h1.json &')
