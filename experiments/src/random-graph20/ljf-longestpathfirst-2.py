...
def perfTest():
    ...
    h9.cmd('iperf3 -c h10 -p 5009 -n 349768.4794921875K -J --logfile experiments/results/0-h9-h10.json &&'
    ...
    h17.cmd('iperf3 -c h10 -p 5017 -n 312767.6298828125K -J --logfile experiments/results/0-h17-h10.json &&'
