...
def perfTest():
    ...
    h12.cmd('iperf3 -c h18 -p 5012 -n 104094.708984375K -J --logfile experiments/results/0-h12-h18.json &&'
            'iperf3 -c h6 -p 5012 -n 247517.658203125K -J --logfile experiments/results/0-h12-h6.json &')

    h10.cmd('iperf3 -c h7 -p 5010 -n 34508.13671875K -J --logfile experiments/results/0-h10-h7.json &&' 
            'iperf3 -c h0 -p 5010 -n 109112.1171875K -J --logfile experiments/results/0-h10-h0.json &&'
            'iperf3 -c h5 -p 5010 -n 145548.6259765625K -J --logfile experiments/results/0-h10-h5.json &')

    h1.cmd('iperf3 -c h13 -p 5001 -n 11606.609375K -J --logfile experiments/results/0-h1-h13.json &&'
           'iperf3 -c h2 -p 5001 -n 14154.220703125K -J --logfile experiments/results/0-h1-h2.json &')

    h8.cmd('iperf3 -c h9 -p 5008 -n 91448.19140625K -J --logfile experiments/results/0-h8-h9.json &&'
           'iperf3 -c h12 -p 5008 -n 143349.6455078125K -J --logfile experiments/results/0-h8-h12.json &&'
           'iperf3 -c h1 -p 5008 -n 175584.7939453125K -J --logfile experiments/results/0-h8-h1.json &')

    h7.cmd('iperf3 -c h3 -p 5007 -n 45271.6318359375K -J --logfile experiments/results/0-h7-h3.json &')

    h18.cmd('iperf3 -c h14 -p 5018 -n 36478.6923828125K -J --logfile experiments/results/0-h18-h14.json &&'
            'iperf3 -c h13 -p 5018 -n 379406.66796875K -J --logfile experiments/results/0-h18-h13.json &')

    h9.cmd('iperf3 -c h19 -p 5009 -n 84280.2431640625K -J --logfile experiments/results/0-h9-h19.json &&'
           'iperf3 -c h10 -p 5009 -n 849768.4794921875K -J --logfile experiments/results/0-h9-h10.json &')

    h6.cmd('iperf3 -c h17 -p 5006 -n 6583.8173828125K -J --logfile experiments/results/0-h6-h17.json &&'
           'iperf3 -c h2 -p 5006 -n 120456.796875K -J --logfile experiments/results/0-h6-h2.json &&'
           'iperf3 -c h12 -p 5006 -n 140983.2392578125K -J --logfile experiments/results/0-h6-h12.json &')

    h5.cmd('iperf3 -c h10 -p 5005 -n 36095.109375K -J --logfile experiments/results/0-h5-h10-1.json &&'
           'iperf3 -c h10 -p 5005 -n 56637.541015625K -J --logfile experiments/results/0-h5-h10-2.json &&'
           'iperf3 -c h0 -p 5005 -n 269865.0224609375K -J --logfile experiments/results/0-h5-h0.json &')

    h2.cmd('iperf3 -c h16 -p 5002 -n 56263.478515625K -J --logfile experiments/results/0-h2-h16.json &&'
           'iperf3 -c h12 -p 5002 -n 522691.72265625K -J --logfile experiments/results/0-h2-h12.json &')

    h19.cmd('iperf3 -c h5 -p 5019 -n 22339.6708984375K -J --logfile experiments/results/0-h19-h5.json &&'
            'iperf3 -c h4 -p 5019 -n 24746.3544921875K -J --logfile experiments/results/0-h19-h4.json &')

    h15.cmd('iperf3 -c h3 -p 5015 -n 93375.5908203125K -J --logfile experiments/results/0-h15-h3.json &')

    h11.cmd('iperf3 -c h13 -p 5011 -n 95982.341796875K -J --logfile experiments/results/0-h11-h13.json &&'
            'iperf3 -c h9 -p 5011 -n 242922.939453125K -J --logfile experiments/results/0-h11-h9.json &')
    ...
    h17.cmd('iperf3 -c h15 -p 5017 -n 91837.056640625K -J --logfile experiments/results/0-h17-h15.json &&'
            'iperf3 -c h18 -p 5017 -n 62212.1416015625K -J --logfile experiments/results/0-h17-h18.json &&'
            'iperf3 -c h10 -p 5017 -n 612767.6298828125K -J --logfile experiments/results/0-h17-h10.json &')

    h0.cmd('iperf3 -c h4 -p 5000 -n 57444.865234375K -J --logfile experiments/results/0-h0-h4.json &&'
           'iperf3 -c h17 -p 5000 -n 142272.03125K -J --logfile experiments/results/0-h0-h17.json &')

    h13.cmd('iperf3 -c h4 -p 5013 -n 118510.6416015625K -J --logfile experiments/results/0-h13-h4.json &&'
            'iperf3 -c h19 -p 5013 -n 350867.173828125K -J --logfile experiments/results/0-h13-h19.json &')

    h7.cmd('iperf3 -c h9 -p 5007 -n 292507.5322265625K -J --logfile experiments/results/0-h7-h9.json &')

    h4.cmd('iperf3 -c h0 -p 5004 -n 33156.5595703125K -J --logfile experiments/results/0-h4-h0.json &&'
           'iperf3 -c h16 -p 5004 -n 406852.98046875K -J --logfile experiments/results/0-h4-h16.json &')
