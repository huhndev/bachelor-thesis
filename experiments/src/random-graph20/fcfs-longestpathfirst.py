...
def perfTest():
    ...
    h6.cmd('iperf3 -c h2 -p 5006 -n 120456.796875K -J --logfile experiments/results/0-h6-h2.json &&'
    ...
    h14.cmd('iperf3 -c h8 -p 5014 -n 127276.6669921875K -J --logfile experiments/results/0-h14-h8.json &&'
            'iperf3 -c h12 -p 5014 -n 387582.615234375K -J --logfile experiments/results/0-h14-h12.json &')
