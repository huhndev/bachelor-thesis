...
def perfTest():
    ...
    h0.cmd('iperf3 -c h3 -p 5000 -n 81740.4833984375K -J --logfile experiments/results/0-h0-h3.json &&'
           'iperf3 -c h8 -p 5000 -n 65028.3095703125K -J --logfile experiments/results/0-h0-h8.json &')

    h8.cmd('iperf3 -c h6 -p 5008 -n 515274.3154296875K -J --logfile experiments/results/0-h8-h6-1.json &&'
           'iperf3 -c h0 -p 5008 -n 55369.248046875K -J --logfile experiments/results/0-h8-h0.json &&'
           'iperf3 -c h6 -p 5008 -n 38879.85546875K -J --logfile experiments/results/0-h8-h6-2.json &')

    h6.cmd('iperf3 -c h7 -p 5006 -n 368781.3291015625K -J --logfile experiments/results/0-h6-h7.json &&'
           'iperf3 -c h8 -p 5006 -n 251047.2119140625K -J --logfile experiments/results/0-h6-h8.json &&'
           'iperf3 -c h0 -p 5006 -n 26633.32421875K -J --logfile experiments/results/0-h6-h0.json &')

    h5.cmd('iperf3 -c h1 -p 5005 -n 423625.2958984375K -J --logfile experiments/results/0-h5-h1.json &&'
           ...
           'iperf3 -c h7 -p 5005 -n 1334.365234375K -J --logfile experiments/results/0-h5-h7.json &')

    h9.cmd('iperf3 -c h6 -p 5009 -n 482361.2451171875K -J --logfile experiments/results/0-h9-h6.json &')

    h3.cmd('iperf3 -c h8 -p 5003 -n 578916.17578125K -J --logfile experiments/results/0-h3-h8.json &&'
           'iperf3 -c h2 -p 5003 -n 279417.1669921875K -J --logfile experiments/results/0-h3-h2.json &&'
           'iperf3 -c h1 -p 5003 -n 196211.390625K -J --logfile experiments/results/0-h3-h1.json &')

    h7.cmd('iperf3 -c h9 -p 5007 -n 394213.576171875K -J --logfile experiments/results/0-h7-h9.json &&'
           'iperf3 -c h6 -p 5007 -n 3289.5634765625K -J --logfile experiments/results/0-h7-h6.json &')
