...
class Topo(IPTopo):
	...
	# DemandAwareLongestPathFirst
        ...
        #self.addLink(h1, h5, igp_metric=983, bw=100, delay="5ms")
...
def perfTest():
    ...
    h8.cmd('iperf3 -c h0 -p 5008 -n 55369.248046875K -J --logfile experiments/results/0-h8-h0.json &&'
           'iperf3 -c h6 -p 5008 -n 515274.3154296875K -J --logfile experiments/results/0-h8-h6-1.json &&'
    ...
    h5.cmd('iperf3 -c h8 -p 5005 -n 175363.046875K -J --logfile experiments/results/0-h5-h8.json &&'
