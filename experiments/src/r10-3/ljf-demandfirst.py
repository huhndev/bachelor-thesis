...
def perfTest():
    ...
    h0.cmd('iperf3 -c h1 -p 5000 -n 423959.90625K -J --logfile experiments/results/0-h0-h1.json &&'
           'iperf3 -c h5 -p 5000 -n 181825.1279296875K -J --logfile experiments/results/0-h0-h5.json &&'
           'iperf3 -c h4 -p 5000 -n 19624.416015625K -J --logfile experiments/results/0-h0-h4.json &')

    h4.cmd('iperf3 -c h2 -p 5004 -n 85347.8818359375K -J --logfile experiments/results/0-h4-h2-1.json &&'
           ...
           'iperf3 -c h2 -p 5004 -n 1880.7138671875K -J --logfile experiments/results/0-h4-h2-2.json &')
    ...
    h7.cmd('iperf3 -c h3 -p 5007 -n 129773.7861328125K -J --logfile experiments/results/0-h7-h3-1.json &&'
           'iperf3 -c h3 -p 5007 -n 35483.896484375K -J --logfile experiments/results/0-h7-h3-2.json &')
