...
def perfTest():
    ...
    h1.cmd('iperf3 -c h4 -p 5001 -n 9290.9970703125K -J --logfile experiments/results/0-h1-h4.json &&'
           'iperf3 -c h3 -p 5001 -n 106560.4677734375K -J --logfile experiments/results/0-h1-h3.json &')

    h9.cmd('iperf3 -c h7 -p 5009 -n 259366.712890625K -J --logfile experiments/results/0-h9-h7.json &')

    h8.cmd('iperf3 -c h4 -p 5008 -n 64831.580078125K -J --logfile experiments/results/0-h8-h4.json &&'
           'iperf3 -c h7 -p 5008 -n 107765.751953125K -J --logfile experiments/results/0-h8-h7.json &&'
           'iperf3 -c h5 -p 5008 -n 115689.8408203125K -J --logfile experiments/results/0-h8-h5.json &')
    ...
    h6.cmd('iperf3 -c h4 -p 5006 -n 22750.7529296875K -J --logfile experiments/results/0-h6-h4.json &&'
           'iperf3 -c h0 -p 5006 -n 50240.060546875K -J --logfile experiments/results/0-h6-h0.json &')
