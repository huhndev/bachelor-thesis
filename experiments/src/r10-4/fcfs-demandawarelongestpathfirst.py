...
def perfTest():
    ...
    h1.cmd('iperf3 -c h8 -p 5001 -n 32422.283203125K -J --logfile experiments/results/0-h1-h8.json &&'
           'iperf3 -c h9 -p 5001 -n 286980.8603515625K -J --logfile experiments/results/0-h1-h9.json &&'
           'iperf3 -c h4 -p 5001 -n 592533.1123046875K -J --logfile experiments/results/0-h1-h4.json &')

    h2.cmd('iperf3 -c h1 -p 5002 -n 185067.421875K -J --logfile experiments/results/0-h2-h1-1.json &&'
           'iperf3 -c h9 -p 5002 -n 336980.5869140625K -J --logfile experiments/results/0-h2-h9.json &&'
    ...
    h6.cmd('iperf3 -c h4 -p 5006 -n 2494.3603515625K -J --logfile experiments/results/0-h6-h4.json &&'
           'iperf3 -c h5 -p 5006 -n 99798.6572265625K -J --logfile experiments/results/0-h6-h5-1.json &&'
    ...
    h8.cmd('iperf3 -c h3 -p 5008 -n 5229.1982421875K -J --logfile experiments/results/0-h8-h3.json &&'
           'iperf3 -c h0 -p 5008 -n 435042.0390625K -J --logfile experiments/results/0-h8-h0.json &&'
    ...
    h0.cmd('iperf3 -c h6 -p 5000 -n 16045.29296875K -J --logfile experiments/results/0-h0-h6.json &&'
           'iperf3 -c h5 -p 5000 -n 32718.517578125K -J --logfile experiments/results/0-h0-h5.json &')

    h7.cmd('iperf3 -c h9 -p 5007 -n 83558.474609375K -J --logfile experiments/results/0-h7-h9.json &&'
           'iperf3 -c h8 -p 5007 -n 574270.1748046875K -J --logfile experiments/results/0-h7-h8.json &')
